...
void go_forward() {
  ...
  Stop(200);
  normal_lights();
  StartMotor (motor1_f, motor1_b, 1, 170);   //fata
  StartMotor (motor2_f, motor2_b, 1, 170);
}
...
void go_back() {
  ...
  Stop(200);
  white_back_lights();
  StartMotor (motor1_f, motor1_b, 0, 170);   //spate
  StartMotor (motor2_f, motor2_b, 0, 170);
}
...
void go_left() {
   ...
   Stop(200);
   normal_lights();
   StartMotor (motor1_f, motor1_b, 1, 250);   // stanga
   StartMotor (motor2_f, motor2_b, 0, 250);
}

void go_right() {

  Stop(200);
  StartMotor (motor1_f, motor1_b, 0, 250);   //dreapta
  StartMotor (motor2_f, motor2_b, 1, 250);
}
